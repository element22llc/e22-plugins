...
Works on **Claude.ai (Chat), Claude Cowork, and Claude Code**. Required:

- **GitHub connector** — same as `/propose`.
- Read access to the Claude Design bundle URL or local path.

Refuse cleanly if the GitHub connector is missing.
