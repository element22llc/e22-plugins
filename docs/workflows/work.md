...
**Issue-first holds in both modes** - [High-risk](../concepts/sdlc.md#change-classification)
work and the six value cases are tied to a GitHub issue; the modes differ only in
the branch/PR ceremony around it.
