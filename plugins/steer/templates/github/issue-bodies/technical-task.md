<!-- steer:schema=2 -->
<!-- steer:kind=task -->
<!-- steer:state=ready-for-dev -->
<!-- steer:source=human -->
<!-- steer:feature-id=FEATURE_ID -->
<!-- steer:spec-path=spec/features/FEATURE_ID/intent.md -->
<!-- steer:parent-issue=PARENT_ISSUE -->
<!-- steer:managed:start -->
## Outcome
...
[How this contributes to the parent feature's outcome. May be indirect for
internal tasks.]
...
[Any `Q-NNN` blocking this slice; link the spec's open questions. Empty if none.]
