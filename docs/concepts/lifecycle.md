...
| Respond to a production incident | [`/steer:work --hotfix`](../workflows/work.md) (fast-path: issue after-the-fact on a `hotfix/<n>-slug` branch, single-reviewer, human gates intact; mandatory post-incident follow-up) |
