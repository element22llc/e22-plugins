# shellcheck shell=sh
# e22-standards hook helper — the shared lifecycle-ordering contract.
#
...
# e22_required_before_order — space-separated gate tokens in lifecycle order,
...
# e22_status_cleared_gate <feature-status> — the required_before gate a feature in
