...
**Purpose.** One-time setup for a new managed repo — bootstrap the /spec spine + scaffolding from the plugin's bundled scaffold, pin the toolchain, and leave the repo working spec-first; also resolves placeholders in a legacy template fork.
