...
printf 'and per-feature ceremony, never the scaffold or the spine. Hand-writing '
printf '`package.json` / build config / CI from scratch here is the failure this '
printf 'notice exists to prevent.\n\n'
