...
flowchart TD
    subgraph SessionStart
      inject[inject-standards.sh<br/>injects Tier 1 rules/*.md<br/>capped at 10,000 chars]
...
the unmarked always-on core. Tier 2 rules scope themselves with `paths:`
