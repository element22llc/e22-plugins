...
when_to_use: "Reached via /steer:setup doctor - not a direct entry point."
# Internal prerequisite path behind `/steer:setup doctor`. Model-callable,
# hidden from the slash menu - see the note on `init`.
