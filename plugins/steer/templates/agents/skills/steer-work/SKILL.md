...
[`modes/subcommands.md`](modes/subcommands.md).
...
- **`--reviewed`** - wrap `start`->`finish` in two independent review gates (plan
  ...
  -> procedure: [`modes/reviewed.md`](modes/reviewed.md)
