...
<!-- Absorbed from always-on rule `20-layout` when the ruleset was split to fit
     the 10,000-character SessionStart cap. Advisory: reaching it is a
     /steer:reference lookup, not an automatic injection. -->
...
<!-- Absorbed from always-on rule `32-living-docs` when the ruleset was split to fit
     the 10,000-character SessionStart cap. Advisory: reaching it is a
     /steer:reference lookup, not an automatic injection. -->
...
<!-- Absorbed from always-on rule `85-practices` when the ruleset was split to fit
     the 10,000-character SessionStart cap. Advisory: reaching it is a
     /steer:reference lookup, not an automatic injection. -->
