...
- [Product spec](./spec/vision.md) - what this product does and why. Spec <-> code rules and templates come from the `steer` plugin: run `/steer:spec`, `/steer:spec adr`, or `/steer:reference conventions`
