...
managed_spine() { # <repo_root>  -> stamp a complete, version-stamped E22 spine
	mkdir -p "$1/spec"
	printf '1.0.0\n' >"$1/spec/.version"
...
# e22_target_path: file_path for Write/Edit/MultiEdit, notebook_path for NotebookEdit.
E22_INPUT='{"tool_name":"Write","tool_input":{"file_path":"f.ts","content":"x"}}'
assert_eq "extract: target_path uses file_path" "$(e22_target_path)" "f.ts"
E22_INPUT='{"tool_name":"NotebookEdit","tool_input":{"notebook_path":"nb.ipynb","new_source":"x"}}'
assert_eq "extract: target_path falls back to notebook_path" "$(e22_target_path)" "nb.ipynb"
