...
#
# WHY THIS EXISTS
#   rule 36-issue-first wants High-risk work and the six value cases tied to a
...
SAFE_BRANCH="$(steer_json_safe "${BRANCH}")"
SAFE_LIST="$(steer_json_safe "${GOVERNED}" | cut -c1-400)"
