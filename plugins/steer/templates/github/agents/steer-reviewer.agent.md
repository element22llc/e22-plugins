<!-- Generated from the steer plugin's agents/steer-reviewer.md - do not edit by hand. Refresh with /steer:setup sync from Claude Code in a managed repo, or mise run gen:copilot in the plugin repo. -->
---
