...
paths:
  - "**"
---
<!-- steer:managed 26-context-hygiene v6.0.0 body-cksum:1872957699 — installed by /steer:init / /steer:adopt and reconciled by /steer:sync. Edit the rule in the steer plugin, not here: a local edit is detected and preserved, but it will not reach any other repo. -->
<!-- PROMOTED back to a binding rule after audit: this carries prohibitions, not
     guidance — routing each fact to its canonical home instead of private session memory. A rule
