...
class Entry:
    ...
    def field(self, name: str) -> str | None:
        ...
        for i, m in enumerate(matches):
            # `Action - an in-file token rewrite` is still the Action field. Split on
            # a SPACED hyphen: the separator used to be an em dash, which could not
            # occur inside a field name, whereas a bare "-" can.
