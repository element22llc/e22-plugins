...
paths:
  - "**"
---
<!-- steer:managed 45-commit-autonomy v6.0.0 body-cksum:3007164424 — installed by /steer:init / /steer:adopt and reconciled by /steer:sync. Edit the rule in the steer plugin, not here: a local edit is detected and preserved, but it will not reach any other repo. -->
