...
Apply the org engineering standards already loaded from `.github/copilot-instructions.md`. The authoritative procedure lives in the steer plugin (in Claude Code, `/steer:help`); this capsule carries the intent so Copilot can drive the same workflow here.
