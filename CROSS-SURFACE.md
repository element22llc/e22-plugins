...
|---|---|---|---|
| **Always-on rules** | `rules/00-router.md` … `99-end-of-session.md` (28 files) | Delivered via `SessionStart` hook → stdout `additionalContext` | Prose is portable; **delivery is hook-bound** |
