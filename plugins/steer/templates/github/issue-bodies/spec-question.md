<!-- steer:schema=2 -->
<!-- steer:kind=spec-question -->
<!-- steer:state=inbox -->
<!-- steer:source=spec -->
<!-- steer:feature-id=FEATURE_ID -->
<!-- steer:spec-path=spec/features/FEATURE_ID/intent.md -->
<!-- steer:question-id=Q-NNN -->
<!-- steer:managed:start -->
## Question

[The unresolved decision, stated as a question. Mirrors the canonical `Q-NNN`
entry in the spec's `## Open questions`.]

## Why this matters

[What is blocked or at risk until this is decided.]
