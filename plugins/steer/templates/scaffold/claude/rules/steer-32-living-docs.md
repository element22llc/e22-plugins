...
paths:
  - "**"
---
<!-- steer:managed 32-living-docs v6.0.0 body-cksum:349946964 — installed by /steer:init / /steer:adopt and reconciled by /steer:sync. Edit the rule in the steer plugin, not here: a local edit is detected and preserved, but it will not reach any other repo. -->
<!-- PROMOTED back to a binding rule after audit: this carries prohibitions, not
     guidance — 'never guess an answer into the spec' and the PO-approval boundary. A rule
