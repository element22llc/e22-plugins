...
`https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/spec/product.md`) and **skip every
...
`https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/scaffold/MANIFEST.md` and follow its
...
templates from `https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/github/` (the MANIFEST's
...
`https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/agents/skills/` to `.agents/skills/`
...
spec spine from
`https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/spec/`:
...
it additively with
`python3 "https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/scripts/scaffold_reconcile.py" auto <target> <scaffold-template> --apply`
...
- **Apply the layered profile overlays** (MANIFEST "Profile overlays"). The
  ...
  **additively** — later layers only *add*:
  - **Node-stack profiles** (`app` / `service` / `library` / `cli` on a Node
    ...
    `https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/scaffold/profiles/_node/` (`package.json`,
  ...
  - **`infra`**: install
    `https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/scaffold/profiles/infra/mise.toml` as the
  ...
  - **`workspace`** (polyrepo spine host): install
    `https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/spec/workspace.yml` as **`spec/workspace.yml`**
    ...
    profile, and instantiate `https://github.com/element22llc/e22-plugins/blob/main/plugins/steer/templates/spec/product.md`
