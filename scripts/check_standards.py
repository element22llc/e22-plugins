...
#
# CHANGELOG.md is exempt: it is a historical record whose older entries
# legitimately name the pre-rebrand skills, and it is generated by
# `changie merge` from `.changes/`, so a gate demanding edits to it would demand
