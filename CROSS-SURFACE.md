...
|---|---|---|---|
| **Always-on rules** | `rules/00-router.md` … `99-end-of-session.md` (27 files) | Delivered via `SessionStart` hook → stdout `additionalContext` | Prose is portable; **delivery is hook-bound** |
...
| **Skills** (23) | `plugins/steer/skills/*` | YAML frontmatter + Markdown body; `/steer:` invocation; `allowed-tools` | **`SKILL.md` is the portable nucleus** |
